...
ifeq ($(UNAME), Linux)
   ...
   BOOST_LDFLAGS=-L$(BOOSTLIB) -Wl,-rpath=$(BOOSTLIB) -Bstatic -lboost_iostreams-mt -lboost_system-mt -lboost_serialization-mt  $(BOOSTLIB)/libboost_serialization.a $(BOOSTLIB)/libboost_system.a $(BOOSTLIB)/libboost_iostreams.a
