...
# -c makes .o files
CFLAGS=$(PLATFORMSPECIFICCFLAGS) -I. -c $(SDL_CFLAGS) -Wconversion -g -Wall
CC=g++
...
NETWORKFILES=Network/ClientCommand.cpp Network/UDP_Server.cpp Network/UDP_Client.cpp Network/NetShard.cpp
